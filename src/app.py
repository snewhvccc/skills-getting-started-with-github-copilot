...
activities = {
    ...
    "Art Studio": {
        "description": "Create paintings, sculptures, and digital artwork",
...
@app.get("/activities")
def get_activities():
    # Ensure the browser always gets fresh activity/participant data.
...
def unregister_from_activity(activity_name: str, email: str):
    ...
    # Validate that the student is currently signed up
